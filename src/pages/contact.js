...
<p class="text-primary text-xl md:text-3xl my-8 mx-2 px-2 py-2">You can stalk me on LinkedIn, like my tweets, roast my code, jam to my playlists, or shoot me an email.</p>
...
<div class="mt-10 mb-15 sm:mt-0 my-6 mx-2 px-2 py-4">
  <div class="md:grid md:grid-cols-3 md:gap-6">
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
      <form class="contact-form" netlify-honeypot="bot-field" action="/contact/" enctype="application/x-www-form-urlencoded" method="POST" data-netlify="true" name="contact">
